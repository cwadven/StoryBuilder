...
class GetUserSheetAnswerSolveHistoriesTestCase(TestCase):
    ...
    def test_get_user_sheet_answer_solve_histories(self):
        ...
        # 1. group_id
        # 2. id
        self.assertEqual(user_sheet_answer_solve_histories[0]['group_id'], self.user_sheet_answer_solve_middle_sheet_history2.group_id)
        self.assertEqual(user_sheet_answer_solve_histories[0]['sheet_title'], self.user_sheet_answer_solve_middle_sheet_history2.sheet.title)
        self.assertEqual(user_sheet_answer_solve_histories[0]['sheet_question'], self.user_sheet_answer_solve_middle_sheet_history2.sheet.question)
        self.assertEqual(user_sheet_answer_solve_histories[0]['user_answer'], self.user_sheet_answer_solve_middle_sheet_history2.answer)
        self.assertEqual(user_sheet_answer_solve_histories[0]['solving_status'], self.user_sheet_answer_solve_middle_sheet_history2.solving_status)
        self.assertEqual(user_sheet_answer_solve_histories[0]['start_time'], self.user_sheet_answer_solve_middle_sheet_history2.start_time.strftime('%Y-%m-%d %H:%M:%S'))
        self.assertEqual(user_sheet_answer_solve_histories[0]['solved_time'], self.user_sheet_answer_solve_middle_sheet_history2.solved_time.strftime('%Y-%m-%d %H:%M:%S'))
        self.assertEqual(user_sheet_answer_solve_histories[1]['group_id'], self.user_sheet_answer_solve_start_sheet_history2.group_id)
        self.assertEqual(user_sheet_answer_solve_histories[1]['sheet_title'], self.user_sheet_answer_solve_start_sheet_history2.sheet.title)
        self.assertEqual(user_sheet_answer_solve_histories[1]['sheet_question'], self.user_sheet_answer_solve_start_sheet_history2.sheet.question)
        self.assertEqual(user_sheet_answer_solve_histories[1]['user_answer'], self.user_sheet_answer_solve_start_sheet_history2.answer)
        self.assertEqual(user_sheet_answer_solve_histories[1]['solving_status'], self.user_sheet_answer_solve_start_sheet_history2.solving_status)
        self.assertEqual(user_sheet_answer_solve_histories[1]['start_time'], self.user_sheet_answer_solve_start_sheet_history2.start_time.strftime('%Y-%m-%d %H:%M:%S'))
        self.assertEqual(user_sheet_answer_solve_histories[1]['solved_time'], self.user_sheet_answer_solve_start_sheet_history2.solved_time.strftime('%Y-%m-%d %H:%M:%S'))
        self.assertEqual(user_sheet_answer_solve_histories[2]['group_id'], self.user_sheet_answer_solve_middle_sheet_history1.group_id)
        self.assertEqual(user_sheet_answer_solve_histories[2]['sheet_title'], self.user_sheet_answer_solve_middle_sheet_history1.sheet.title)
        self.assertEqual(user_sheet_answer_solve_histories[2]['sheet_question'], self.user_sheet_answer_solve_middle_sheet_history1.sheet.question)
        self.assertEqual(user_sheet_answer_solve_histories[2]['user_answer'], self.user_sheet_answer_solve_middle_sheet_history1.answer)
        self.assertEqual(user_sheet_answer_solve_histories[2]['solving_status'], self.user_sheet_answer_solve_middle_sheet_history1.solving_status)
        self.assertEqual(user_sheet_answer_solve_histories[2]['start_time'], self.user_sheet_answer_solve_middle_sheet_history1.start_time.strftime('%Y-%m-%d %H:%M:%S'))
        self.assertEqual(user_sheet_answer_solve_histories[2]['solved_time'], self.user_sheet_answer_solve_middle_sheet_history1.solved_time.strftime('%Y-%m-%d %H:%M:%S'))
        self.assertEqual(user_sheet_answer_solve_histories[3]['group_id'], self.user_sheet_answer_solve_start_sheet_history1.group_id)
        self.assertEqual(user_sheet_answer_solve_histories[3]['sheet_title'], self.user_sheet_answer_solve_start_sheet_history1.sheet.title)
        self.assertEqual(user_sheet_answer_solve_histories[3]['sheet_question'], self.user_sheet_answer_solve_start_sheet_history1.sheet.question)
        self.assertEqual(user_sheet_answer_solve_histories[3]['user_answer'], self.user_sheet_answer_solve_start_sheet_history1.answer)
        self.assertEqual(user_sheet_answer_solve_histories[3]['solving_status'], self.user_sheet_answer_solve_start_sheet_history1.solving_status)
        self.assertEqual(user_sheet_answer_solve_histories[3]['start_time'], self.user_sheet_answer_solve_start_sheet_history1.start_time.strftime('%Y-%m-%d %H:%M:%S'))
        self.assertEqual(user_sheet_answer_solve_histories[3]['solved_time'], self.user_sheet_answer_solve_start_sheet_history1.solved_time.strftime('%Y-%m-%d %H:%M:%S'))
